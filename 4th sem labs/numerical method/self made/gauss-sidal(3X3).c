/* 
	****GAUSS-SIDEL ITERATION(3X3)METHOD*******
	CREATED BY:- SULPHURIC.SUDIP
	STARTED ON:- SEP-16, 2O2O  -making smal change in jacobi-iteration 
*/
...
int main(){
	...
	changeColor(12);
	gotoxy(10,11);printf("GIvE InItIaL GuEsS FoR Y & Z:   ");
	scanf("%f%f",&y[0],&z[0]);
